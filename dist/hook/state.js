 ...
 */
export function readSyncState(statePath = DEFAULT_STATE_PATH) {
 ...
 * @param statePath - Path to the sync state file
 */
export function writeSyncState(state, statePath = DEFAULT_STATE_PATH) {
    const absolutePath = path.isAbsolute(statePath)
        ? statePath
        : path.resolve(process.cwd(), statePath);
 ...
 */
export function isTaskSynced(taskId, state) {
 ...
 */
export function getTaskMapping(taskId, state) {
 ...
 */
export function addTaskMapping(state, mapping) {
    return {
        ...state,
        taskMappings: {
            ...state.taskMappings,
 ...
 */
export function removeTaskMapping(state, taskId) {
 ...
 */
export function getSyncedTaskIds(state) {
 ...
 */
export function getAllMappings(state) {
 ...
 * @returns The task mapping if found, undefined otherwise
 */
export function findMappingByIssueNumber(issueNumber, state) {
    return Object.values(state.taskMappings).find(mapping => mapping.githubIssueNumber === issueNumber);
}
